...
CONTEST_YEARS = os.environ.get('CONTEST_YEARS', '2024,2025,2026: Available here Monday May 1 ').split(',')
CONTEST_YEAR = os.environ.get('CONTEST_YEAR', '2026')
...
RANKINGS = {
   ...
   # 'TB-WIRES': 'TB-WIRES Overlay'
    ...
    'PS': 'WIRES Overlay - SSB (phone) Mode',
    'PC': 'WIRES Overlay - CW/Digital Mode',
    'PM': 'WIRES Overlay - MIXED Modes (SSB, CW, Digital)',
}
...
LEADERBOARDS = [
    ...
    [
        {
            'section_title': 'Parks on the Air Overlay',
            'show': [
                ['callsign', 'CallSign'],
                ['final_score', 'Score'],
                ['claimed_score', 'Claimed'],
